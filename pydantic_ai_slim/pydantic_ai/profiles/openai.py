...
def openai_model_profile(model_name: str) -> ModelProfile:
    ...
    return _openai_profile_reasoning if is_reasoning_model else _openai_profile_non_reasoning
...
_openai_profile_reasoning = OpenAIModelProfile(
...
_openai_profile_non_reasoning = OpenAIModelProfile(
    json_schema_transformer=OpenAIJsonSchemaTransformer,
    supports_json_schema_output=True,
    supports_json_object_output=True,
